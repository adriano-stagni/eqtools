...
class Spline():
    ...
    def _check_bounds(self, x_new, y_new, z_new):
        ...
        out_of_bounds = numpy.logical_not(numpy.logical_or(numpy.logical_or(numpy.logical_or(below_bounds_x, above_bounds_x),
...
class RectBivariateSpline(scipy.interpolate.RectBivariateSpline):
    ...
    def _check_bounds(self, x_new, y_new):
        ...
        out_of_bounds = numpy.logical_not(numpy.logical_or(numpy.logical_or(below_bounds_x, above_bounds_x),
                                                           numpy.logical_or(below_bounds_y, above_bounds_y)))
        return out_of_bounds
    ...
    def ev(self, xi, yi):
        ...
        zi[idx] = super(RectBivariateSpline, self).ev(numpy.atleast_1d(xi)[idx],
                                                      numpy.atleast_1d(yi)[idx])
        return zi
